...
Keep profile text in this folder before placing it into the website layouts.

## Files

- `profile.md`: name, introduction, research statement and links
- `education.md`: education history and academic focus
- `experience.md`: SANY full-time role and compact internship entries for the Career page
- `projects.md`: two SANY VLA welding project pages and editable content slots
...
Do not store passwords, API keys or private data in this repository.
