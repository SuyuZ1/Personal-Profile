...
快速增长的 VLA 领域已有大量分类，却缺少能够解释能力构成、技术演进与未来路径之间关系的统一结构。研究需要从“有哪些工作”进一步走向“能力为何形成、路线为何变化、下一步受什么约束”。
...
- 为研究与工程团队提供理解 VLA 系统能力栈的共同语言
- 支持从系统依赖而非单一模型分数出发进行技术判断
- 以 Living Survey 形式维护可持续更新的研究路线图
...
- Unified survey anatomy: `../../assets/uploads/research/topic-01/vla-survey-anatomy.webp`
