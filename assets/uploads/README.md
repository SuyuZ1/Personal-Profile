...
- `experience/`: Career visuals and institution marks; `damo-academy.png` is sourced from the official DAMO Academy website, and `sany-group-logo.svg` from SANY Global's official website
- `education/`: institution images or supporting material
- `research/topic-01/`: papers, figures and source images for topic 01
